package bootloader
{
    ...
    public class YdLPJZlzxNa9V extends flash.display.Sprite
    {
        public function YdLPJZlzxNa9V(arg1:flash.display.Stage, arg2:String)
        {
            super();
            var loc2:*=384;
            var loc1:*=128;
            this.x = (arg1.stageWidth - loc2) / 2;
            this.y = (arg1.stageHeight - loc1) / 2;
            graphics.clear();
