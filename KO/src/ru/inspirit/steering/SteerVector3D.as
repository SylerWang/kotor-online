package ru.inspirit.steering 
{
	...
	public final class SteerVector3D extends Vector3D
	{
		...
		public function setToNumber(x:Number = 0, y:Number = 0, z:Number = 0):void
		{
			this.x = x;
			this.y = y;
			this.z = z;
		...
		//TO DO DHK
		public function adding(a:SteerVector3D):SteerVector3D
		{
			return new SteerVector3D(x+a.x,y+a.y,z+a.z);
		}
		
		public function diff(a:SteerVector3D):SteerVector3D
		{
			return new SteerVector3D(x-a.x,y-a.y,z-a.z);
		}
		
		public function diffAbs(a:SteerVector3D):SteerVector3D
		{
			return new SteerVector3D(Math.abs(x-a.x),Math.abs(y-a.y),Math.abs(z-a.z));
		}
