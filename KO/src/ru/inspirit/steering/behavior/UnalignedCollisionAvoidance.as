package ru.inspirit.steering.behavior 
{
	...
	{
		public var collisionDangerThreshold:Number = 50; // should be around 3 * Vehicle Radius
		public var predict:Number = 25;
		
		public var avoidList:Vehicle;
		
		public function UnalignedCollisionAvoidance(avoidList:Vehicle = null, collisionDangerThreshold:Number = 60, predict:Number = 25)
		{
		...
		{			
			...
			var time:Number;
			var minTime:Number = avoidList.vehicleRadius*1.5;
			var relSpeed:Number;
